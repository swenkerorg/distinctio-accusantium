...
[![NPM Version](https://img.shields.io/npm/v/@swenkerorg/distinctio-accusantium.svg)](https://npmjs.org/package/@swenkerorg/distinctio-accusantium)
[![NPM Downloads](https://img.shields.io/npm/dw/@swenkerorg/distinctio-accusantium.svg)](https://npmjs.org/package/@swenkerorg/distinctio-accusantium)
...
```typescript
import { z } from "zod";
import { zodToJsonSchema } from "@swenkerorg/distinctio-accusantium";
...
```typescript
import zodToJsonSchema, { ignoreOverride } from "@swenkerorg/distinctio-accusantium";
...
https://github.com/swenkerorg/distinctio-accusantium/blob/master/changelog.md
